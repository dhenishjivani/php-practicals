    ...
    <form action="" id="form">
        <div class="form-floating container mt-5">
            <div class="form-group">
                <textarea name="textData" id="floatingTextarea" cols="30" rows="4" placeholder="Enter text here" class="form-control"></textarea>
            </div>
            <input type="submit" name="submit" value="Post" class="btn btn-outline-info mt-5">
